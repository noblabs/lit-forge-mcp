...
// 次サイクル予定: BLS（雇用統計・CPI・PPI）/ 総務省統計局（日 CPI）/ FOMC。
...
export const getEconomicReleasePulseTool: LitForgeTool = {
  ...
  description:
    ...
    "FRB（米 鉱工業生産 G.17）、内閣府（四半期別 GDP 速報）、日銀（金融政策決定会合 / 主な意見 / 短観 / 議事要旨）。" +
    "BLS（雇用統計・CPI・PPI）・総務省統計局（日 CPI）・FOMC は次サイクルで追加予定で、現時点では本ツールに含まれません。" +
    "【利用上の注意】" +
