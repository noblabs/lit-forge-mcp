...
// v0.19.0 でセンサス局 Advance Economic Indicators 追加）。
//
// 役割分担:
...
//   - S&P Global（米）: 製造業 / サービス業 PMI 速報（flash, 09:45 ET）— 公式カレンダー手転記
  ...
  country: z
    ...
    .describe(
      "国コード絞り込み: US=米国 / JP=日本 / EU / GB / CN。未指定で全件。" +
        "現行カバーは US（BEA・NY 連銀・FRB・BLS・DOL/ETA・S&P Global・センサス局）と JP（内閣府・日銀）のみ",
    ),
};
...
export const getEconomicReleasePulseTool: LitForgeTool = {
  ...
  description:
    ...
    "**S&P Global**（米 製造業/サービス業 PMI 速報 — flash, 09:45 ET。発表日は公式カレンダーから手転記）、" +
